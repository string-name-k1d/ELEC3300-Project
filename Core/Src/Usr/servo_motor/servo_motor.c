...
static inline TIM_HandleTypeDef* servo_get_tim_handle(u8 tid) { return (tid == 2) ? &htim2 : (tid == 3) ? &htim3 : 0; }

static inline u32 servo_get_tim_channel(u8 chid) { return TIM_CHANNEL_1 + 4 * (chid - 1); }
